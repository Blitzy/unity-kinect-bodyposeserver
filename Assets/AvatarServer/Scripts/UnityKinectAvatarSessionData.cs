...
[System.Serializable]
public class UnityKinectAvatarSessionData : UnitySessionData
{
    [SerializeField]
    [HideInInspector]
    ...
    protected override void UpdateDataFromLocal() {
        ...
        _offsetFromCamera = _CalcOffsetFromCamera();
    }
    ...
    protected override void UpdateLocalFromData() {
        ...
        transform.localPosition = Camera.main.transform.localPosition + _offsetFromCamera;
    }
    ...
    private bool _HasBoneTransformChanged() {
        ...
        var curOffsetFromCamera = _CalcOffsetFromCamera();
        if (!curOffsetFromCamera.Equals(_offsetFromCamera)) {
            return true;
        }
    ...
    private Vector3 _CalcOffsetFromCamera() {
        return transform.localPosition - Camera.main.transform.localPosition;
    }
